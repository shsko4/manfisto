...
use App\Models\Load as TheModel;
use Illuminate\Support\Facades\Auth;

class ManageLoad extends Component
{
    /*-------------------------------------------------------------------VARIABLES----------*/
    ...
    {
        return [
            'name' => 'required|unique:loads'
        ];
    }

    /*-------------------------------------------------------------------MESSAGES----------*/
    protected $messages = [
        'name.unique' => 'الإسم  مسجل مسبقاً !',
    ];
    ...
    {
        return view('livewire.manage-load');
    }
}
