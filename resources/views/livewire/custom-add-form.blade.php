...
<div>
    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <input type="hidden" required class="form-control" placeholder="" wire:model="custom_id" id='custom_id'
                name='custom_id' required>
        </div>
        <!-------------->
        <div class="col-span-5">
            <label for="cert_no">رقم الشهادة الجمركية <span class="tx-danger">*</span></label>
            <input type="text" required class="form-control" placeholder="" wire:model="cert_no" id='cert_no'
                name='cert_no' required>
        ...
        <div class="col-span-7 mr-2">
            <label for="cert_recipt_no">رقم الإيصال الجمركي <span class="tx-danger">*</span></label>
            <input type="text" required class="form-control" placeholder="" wire:model="cert_recipt_no"
        ...
        <div class="col-md-3">
            ...
            <input type="number" required class="form-control" placeholder="0" wire:model="nolon" id='nolon'
                name='nolon' value="0">
    ...
    <div class="row mt-2">
        ...
        <div class="col-md-3">
            ...
            <input type="number" required class="form-control" placeholder="0" wire:model="stamp" id='stamp'
                name='stamp' value="0" readonly>
        ...
        <div class="col-md-3">
            ...
            <input type="number" required class="form-control" placeholder="0" wire:model="total" id='total'
