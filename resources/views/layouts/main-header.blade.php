<!-- main-header opened -->
<div class="main-header sticky side-header nav nav-item w-auto" >
    <div class="container-fluid">
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href="{{ url('/' . ($page = 'index')) }}"><img src="{{ URL::asset('assets/img/brand/headertax3.png') }}"
                                ...
                                <div id="unreadNotifications">
                                    ...
                                    <div class="main-notification-list Notification-scroll">
                                        <a class="d-flex p-3 border-bottom"
                                            href="{{ route('invoice_details.edit', ['id' => $notification->data['id'], 'notification' => $notification->id]) }}">
                                            <div class="mr-3">
