...
@section('content')
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="card" style="width: 800px; left: 70px;">
...
<script src="{{ URL::asset('assets/js/modal.js') }}"></script>
    ...
    <script>
        ...
        window.addEventListener('swal-city-del-modal', event => {
            $('#modalDeleteCity').modal('show');
        });

        window.addEventListener('swal-city-del-modal-hide', event => {
